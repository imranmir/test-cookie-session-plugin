...
log4j = {
    ...
    info 'com.granicus.grails.plugins.cookiesession.CookieSessionFilter'
    info 'com.granicus.grails.plugins.cookiesession.SessionRepositoryRequestWrapper'
...
grails.plugin.springsecurity.controllerAnnotations.staticRules = [
        '/console/**': 			['IS_AUTHENTICATED_ANONYMOUSLY'],'/':      ['IS_AUTHENTICATED_ANONYMOUSLY']]

// Added by the Spring Security Core plugin:
grails.plugin.springsecurity.userLookup.userDomainClassName = 'com.im.User'
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'com.im.UserRole'
grails.plugin.springsecurity.authority.className = 'com.im.Role'
//grails.plugin.springsecurity.switchUser.targetUrl = '/user/index'
grails.plugin.springsecurity.successHandler.defaultTargetUrl = '/user/index'
grails.plugin.springsecurity.logout.afterLogoutUrl = '/user/afterLogout'
